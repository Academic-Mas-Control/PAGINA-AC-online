       ...
       .then(data => {
           ...
           data.secciones.forEach(seccion => {
               ...
               subtituloElement.innerHTML = seccion.subtitulo;
               ...
               texto1Element.classList.add("display-4");  // Agrega la clase "display-4"
               texto1Element.style.marginBottom = "5px";  // Agrega estilo margin-bottom: 0px
